...
local_neurogym_path = os.path.abspath('/Users/jacobtanner/neurogym_match_to_discrete/neurogym')
...
env = gym.make('FindSensePairs-v0')  # Replace 'YourEnvName-v0' with the ID you used during registration
